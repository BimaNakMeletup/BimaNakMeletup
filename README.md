...
- 🚀 **Specialization:** Building scalable systems with modern frameworks (Laravel, FastAPI, Flutter).
- 🔌 **Side Quests:** Experimenting with IoT, hardware microcontrollers, and micro-interactions.
- ⚽ **Passions:** Big fan of clean UI/UX code layouts, and closely following the world of football.
- 🛠️ **Design Philosophy:** *"Striking yet elegant"* — keeping interfaces minimalist but visually powerful.
